...
- platform-side OpenClaw architecture and owner model:
  - [platform-engineering/products/openclaw/architecture-and-owner-model.md](../platform-engineering/products/openclaw/architecture-and-owner-model.md)
- platform-side OpenClaw runtime and operator docs:
  - [platform-engineering/products/openclaw/README.md](../platform-engineering/products/openclaw/README.md)
...
- host-control security posture:
  - [security-architecture/docs/architecture/domains/host-control.md](../security-architecture/docs/architecture/domains/host-control.md)
